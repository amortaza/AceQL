...
func newTestUtil_NodeCompiler() *testUtil_NodeCompiler {
	return &testUtil_NodeCompiler{}
}

func (compiler *testUtil_NodeCompiler) AndCompile(and *node.And) (string, error) {
...
func (compiler *testUtil_NodeCompiler) ColumnCompile(column *node.Column) (string, error) {
...
func (compiler *testUtil_NodeCompiler) ContainsCompile(contains *node.Contains) (string, error) {
...
func (compiler *testUtil_NodeCompiler) EndsWithCompile(endsWith *node.EndsWith) (string, error) {
...
func (compiler *testUtil_NodeCompiler) GreaterThanCompile(greaterThan *node.GreaterThan) (string, error) {
...
func (compiler *testUtil_NodeCompiler) InCompile(inNode *node.In) (string, error) {
...
func (compiler *testUtil_NodeCompiler) IsNullCompile(isNull *node.IsNull) (string, error) {
...
func (compiler *testUtil_NodeCompiler) LessThanCompile(lessThan *node.LessThan) (string, error) {
...
func (compiler *testUtil_NodeCompiler) NotCompile(notNode *node.Not) (string, error) {
...
func (compiler *testUtil_NodeCompiler) NumberCompile(number *node.Number) (string, error) {
...
func (compiler *testUtil_NodeCompiler) NumberListCompile(numberList *node.NumberList) (string, error) {
...
func (compiler *testUtil_NodeCompiler) OrCompile(orNode *node.Or) (string, error) {
...
func (compiler *testUtil_NodeCompiler) StartsWithCompile(startsWith *node.StartsWith) (string, error) {
...
func (compiler *testUtil_NodeCompiler) StringCompile(stringNode *node.String) (string, error) {
	return "'" + stringNode.Text + "'", nil
}

func (compiler *testUtil_NodeCompiler) StringListCompile(stringList *node.StringList) (string, error) {
